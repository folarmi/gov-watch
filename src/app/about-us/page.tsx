...
>>>>>>> a5253702df24d0dd7292ec8577fd3e44d238cc8d
...
>>>>>>> a5253702df24d0dd7292ec8577fd3e44d238cc8d
        ...
        <div>
          <div className="mb-14">
            <h1 className="font-bold text-2xl text-green-700 mb-4 flex justify-center">OUR MISSION</h1>
            <p className="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Id eius, corporis sed impedit nulla aut animi maiores dolorem laboriosam quae facere sunt, hic voluptatum non facilis, officia porro! Officia, impedit?</p>
          </div>

          <div className="mb-14">
            <h1 className="font-bold text-2xl text-green-700 mb-4 flex justify-center">OUR VISION</h1>
            <p className="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Id eius, corporis sed impedit nulla aut animi maiores dolorem laboriosam quae facere sunt, hic voluptatum non facilis, officia porro! Officia, impedit?</p>
          </div>

          <div>
            <h1 className="font-bold text-2xl text-green-700 mb-4 flex justify-center">OUR OBJECTIVE</h1>
