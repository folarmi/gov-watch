...
export const sampleData = [
  {
    publicId: "742fbf94-0f23-43b7-953e-20b149442bf8",
    publicationPublicId: "a7ed27d8-cd5c-4094-a0f4-4832698c27b1",
    title: "Submitted Article",
    recipientId: "3038ed98-50da-44ff-9e38-01a0f0d6bfba",
    isApproved: null,
    isRead: true,
    comment:
      "Congratulations! your article Testing IsDraftUpdateLoading has been submitted successfully!",
    isGeneral: false,
    isSuccessful: false,
    statusCode: 0,
    remark: null,
