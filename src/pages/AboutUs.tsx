          ...
          <div className="flex flex-row justify-between gap-8 sm:gap-16 md:gap-32 lg:gap-56">
            <div className="mr-17 mb-16">
              ...
              <p className="text-sm">
                ...
                aliquid at, temporibus labore dolorem animi praesentium,
                deleniti vel id facere itaque dicta vero accusantium qui
                architecto!. Lorem ipsum dolor sit amet consectetur adipisicing
                elit. Atque minima dolore cupiditate inventore, eaque asperiores
                voluptate quos sapiente tempore, ex reprehenderit cum deserunt
                natus dolorem est, ipsam ducimus magni tempora.
                <br />
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor
                nesciunt itaque, consectetur minima accusamus temporibus, iste
                sed consequatur cupiditate non veniam aliquid laboriosam ipsa
                ...
                aliquam quaerat sed quidem. Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Sequi beatae natus autem explicabo
                hic sint consequatur, sunt, delectus ipsa deserunt voluptas
                fugit magnam, quidem asperiores omnis? Neque ea similique
                molestiae?
              </p>
            </div>
